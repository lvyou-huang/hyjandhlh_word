...
async function ask_for_data() {
    let res = await fetch('http://localhost:8080/freebie',{
        method:'post',
        headers:{
...
new_list.onclick=async function(){
    ...
    let res = await fetch('http://localhost:8080/freebie?status=new',{
        method:'post',
        headers:{
            'Content-type':'application/json'
        }
...
hot_list.onclick=async function(){
    ...
    let res = await fetch('http://localhost:8080/freebie?status=hot',{
        method:'post',
        headers:{
            'Content-type':'application/json'
        }
